...
$cek3=mysqli_query($con,"SELECT * FROM signup WHERE username='$username'");
if(mysqli_num_rows($cek1)==0)
{
    if(mysqli_num_rows($cek2)==0)
    {
        ...
        {
$query=mysqli_query($con,"INSERT INTO signup(nama,email,jeniskelamin,username,password)
VALUES ('$nama','$email','$jenis','$username','$password')");
if($query)
{
    echo"<script>alert('Akun anda berhasil didaftar');
        document.location.href='../community.html';</script>";
}
else
{
